...
moduleForModel('i-i-s-kursovaya16-дир-отд-по-раб-с-кл', 'Unit | Serializer | i-i-s-kursovaya16-дир-отд-по-раб-с-кл', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya16-дир-отд-по-раб-с-кл',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

    ...
    public class ДирОтдПоРабСКл : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДирОтдПоРабСКлE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДирОтдПоРабСКлE", typeof(IIS.Kursovaya16.ДирОтдПоРабСКл));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДирОтдПоРабСКлL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДирОтдПоРабСКлL", typeof(IIS.Kursovaya16.ДирОтдПоРабСКл));
                }
            }
        }
    }

...
namespace IIS.Kursovaya16
{
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya16.DetailArrayOfОказКонсульт fОказКонсульт;
        ...
        public virtual IIS.Kursovaya16.DetailArrayOfОказКонсульт ОказКонсульт
        {
            get
            {
                ...
                {
                    this.fОказКонсульт = new IIS.Kursovaya16.DetailArrayOfОказКонсульт(this);
                }
                IIS.Kursovaya16.DetailArrayOfОказКонсульт result = this.fОказКонсульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.Kursovaya16.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.Kursovaya16.РасчетОстВрем));
                }
            }
        }
    }
